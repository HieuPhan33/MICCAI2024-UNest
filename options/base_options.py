...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='unaligned', help='chooses how datasets are loaded. [ct, unaligned | aligned | single | colorization]')
        ...
        parser.add_argument('--pad_size', type=int, default=512, help='pad images to this size')
