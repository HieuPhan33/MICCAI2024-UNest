...
class Transformer(nn.Module):
    def __init__(self,config, img_size, vis,in_channels=3,old = 1):
        ...
        self.embeddings = Embeddings(config,img_size=(img_size, img_size),input_dim=in_channels,old = old)
...
class ART_block(nn.Module):
    def __init__(self,config, input_dim, img_size=(224,224), ngf=32, transformer = None):
...
class ResViT(nn.Module):
    def __init__(self,config, input_dim, img_size=(224,224), output_dim=3, vis=False):
        ...
        ####################################ART Blocks##############################################
        mult = 4
        self.art_1 = ART_block(self.config, input_dim, img_size, ngf=ngf, transformer = self.transformer_encoder)
        self.art_2 = ART_block(self.config, input_dim, img_size, ngf=ngf, transformer = None)
        self.art_3 = ART_block(self.config, input_dim, img_size, ngf=ngf, transformer = None)
        # self.art_4 = ART_block(self.config, input_dim, img_size, ngf=ngf, transformer=None)
        # self.art_5 = ART_block(self.config, input_dim, img_size, ngf=ngf, transformer=None)
        # self.art_6 = ART_block(self.config, input_dim, img_size, ngf=ngf, transformer = self.transformer_encoder)
...
if __name__ == '__main__':
    ...
    net = ResViT(config,input_dim = 1, img_size = img_size, output_dim=1, vis=False)
    out = net(x)
    print(out.shape)
